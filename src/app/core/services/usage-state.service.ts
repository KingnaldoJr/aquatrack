...
const MOCK_USAGE: WaterUsage[] = [
  {
    ...
    currentMeterReading: 15000,
    previousMeterReading: 13400,
    consumption: 1600,
  },
  {
    id: 'u2',
    ...
    condominiumId: '1',
    readingDate: new Date('2024-05-15'),
    currentMeterReading: 13000,
    previousMeterReading: 11600,
    consumption: 1400,
  },
  {
    id: 'u3',
    ...
    condominiumId: '1',
    readingDate: new Date('2024-05-15'),
    currentMeterReading: 17000,
    previousMeterReading: 15200,
    consumption: 1800,
  },
  {
    id: 'u4',
    ...
    condominiumId: '1',
    readingDate: new Date('2024-05-15'),
    currentMeterReading: 12000,
    previousMeterReading: 10700,
    consumption: 1300,
  },
  {
    id: 'u5',
    ...
    condominiumId: '1',
    readingDate: new Date('2024-05-15'),
    currentMeterReading: 19000,
    previousMeterReading: 17000,
    consumption: 2000,
  },
  {
    id: 'u6',
    ...
    currentMeterReading: 13400,
    previousMeterReading: 11900,
    consumption: 1500,
  },
  {
    id: 'u7',
  ...
  },
  {
    ...
    condominiumId: '1',
    readingDate: new Date('2024-04-15'),
    currentMeterReading: 10700,
    previousMeterReading: 9500,
    consumption: 1200,
  },
  {
    id: 'u10',
...
export class UsageStateService {
  ...
  readonly averageConsumption = computed(() => {
    ...
    const total = latestUsagePerHouse.reduce(
  ...
  readonly usageByHouseChartData = computed(() => {
    ...
    return {
      labels: latestUsagePerHouse.map(
        (u) => houses.find((h) => h.id === u.houseId)?.houseNumber ?? 'Unknown',
      ),
  ...
  readonly detailedUsageTableData = computed(() => {
    ...
    return latestUsagePerHouse.map((u) => {
      ...
      const status: 'Normal' | 'High' =
        u.consumption > avg * 1.1 ? 'High' : 'Normal';
      return {
        houseId: u.houseId,
